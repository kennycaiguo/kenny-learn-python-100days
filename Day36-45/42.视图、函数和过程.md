...
![image-20260619154207971](./42.视图、函数和过程.assets/image-20260619154207971.png)
...
### 用pymsql来创建mysql函数，注意：在sql语句里面不要使用delimiter关键字否则报错
...
![image-20260619160139144](./42.视图、函数和过程.assets/image-20260619160139144.png)
