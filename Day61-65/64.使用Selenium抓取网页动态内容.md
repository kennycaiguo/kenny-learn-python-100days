...
#### 如果你下载了正确版本的ChromeDriver并且安装到了正确的路径，就会出现下面的效果

![image-20260711132724503](./64.使用Selenium抓取网页动态内容.assets/image-20260711132724503.png)

如果不愿意使用 Chrome 浏览器，也可以修改上面的代码操控其他浏览器，只需创建对应的浏览器对象（如 Firefox、Safari 等）即可。

#### 运行上面的程序，如果看到如下所示的错误提示，那是说明我们还没有将 Chrome 浏览器的驱动添加到 PATH 环境变量中，也没有在程序中指定 Chrome 浏览器驱动所在的位置。
...
![image-20260711131904959](./64.使用Selenium抓取网页动态内容.assets/image-20260711131904959.png)
...
![image-20260711183625428](./64.使用Selenium抓取网页动态内容.assets/image-20260711183625428.png)
