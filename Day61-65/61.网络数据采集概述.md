...
3. HTTPie：命令行HTTP客户端。
   ...
   ```Bash
   http --header https://m.douban.com/movie/
...
5. `python-whois`库：查询网站所有者的工具。
   ...
   """返回结果
   {
     ...
     "referral_url": null,
     "updated_date": [
       "2024-12-03 21:03:37+00:00",
       "2024-12-03 16:03:36+00:00"
     ],
     "creation_date": [
       "1993-04-02 05:00:00+00:00",
       "1993-04-02 00:00:00+00:00"
     ],
     "expiration_date": [
       "2034-10-20 19:56:17+00:00",
       "2034-10-20 14:56:17+00:00"
     ],
     "name_servers": [
       "A.R10.TWTRDNS.NET",
       "A.U10.TWTRDNS.NET",
