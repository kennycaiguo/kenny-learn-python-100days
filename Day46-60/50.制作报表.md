...
我们在templates文件夹里面创建一个teacher_stat.html文件，内容如下
...
然后我们需要创建一个teacher_stat路由，用来渲染这个数据

![image-20260706092221537](./50.制作报表.assets/image-20260706092221537.png)

然后我们需要在polls/views.py里面创建teacher_stat函数

![image-20260706092351946](./50.制作报表.assets/image-20260706092351946.png)

运行效果如下图所示。

![image-20260706092457231](./50.制作报表.assets/image-20260706092457231.png)
